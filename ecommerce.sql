...
INSERT INTO `paises` (pais_id, nombre, pais_cod)
...
INSERT INTO `provincias` (provincia_id, nombre, pais_id)
VALUES (1,'Buenos Aires',11),
	   (2,'Catamarca',11),
       (3,'Chaco',11),
       (4,'Chubut',11),
       (5,'Córdoba',11),
...
INSERT INTO `ciudades` (ciudad_id, nombre, provincia_id)
...
VALUES (1,'Zapatillas runner',NULL,5500,1,1),
	   (2,'Zapatillas tennis',NULL,3600,1,1),
       (3,'Camiseta Boca Juniors',NULL,1100,2,2),
       (4,'Camiseta River Plate',NULL,1100,2,1),
       (5,'Zapatillas skateboard',NULL,3000,1,8),
       (6,'Pelota de fútbol',NULL,1200,8,4),
       (7,'Guantes de boxeo',NULL,1600,8,1),
       (8,'Short deportivo',NULL,1100,3,2),
       (9,'Campera Boca Junios',NULL,2200,4,2),
       (10,'Campera Seleccion Argentina',NULL,2500,4,2),
       (11,'iPhone X',NULL,65000,9,11),
       (12,'Galaxy s10',NULL,54000,9,12),
       (13,'Moto G6S Plus',NULL,25000,9,13),
       (14,'Laptop Republic of Gamers GL551J',NULL,60000,11,14),
       (15,'Laptop Satellite Pro C840',NULL,1100,11,16),
       (16,'TV 55" S4638',NULL,1100,8,21),
       (17,'TV 50" HLE5017',NULL,1100,8,20),
       (18,'iPod nano',NULL,1100,12,11),
       (19,'Auriculares SN4309',NULL,1100,12,21),
       (20,'Licuadora Smartchef',NULL,1100,10,18),
       (21,'Nevera D60350NX',NULL,1100,10,17);
