...
queries = {
    ...
    'get_user_id':'SELECT * FROM usuarios WHERE usuario_id = %s',
    'get_user_dni':'SELECT * FROM usuarios WHERE dni = %s',
    ...
    'get_product_id':'SELECT * FROM productos WHERE producto_id = %s',
    'add_user':'INSERT INTO usuarios (dni, nombre, apellido, email, telefono, clave) VALUES (%s, %s, %s, %s, %s, %s)',
    'add_address':'INSERT INTO direcciones (direccion) VALUES (%s)',
    'add_city':'INSERT INTO ciudades (nombre) VALUES (%s)',
    'add_province':'INSERT INTO provincias (nombre) VALUES (%s)',
    'add_country':'INSERT INTO paises (nombre) VALUES (%s)',
